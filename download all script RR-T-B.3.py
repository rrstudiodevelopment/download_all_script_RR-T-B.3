...
ENCODED_URL = "aHR0cHM6Ly9naXRodWIuY29tL3Jyc3R1ZGlvZGV2ZWxvcG1lbnQvUlItVC1CLjNfVjA0L2FyY2hpdmUvcmVmcy9oZWFkcy9tYWluLnppcA=="
...
# ===================================================================
# TOKEN TERSEMBUNYI (SUPER SAFE)
# ===================================================================
def _internal_secure_key():
    """Token GitHub disembunyikan dan dipartisi."""
...
def main():
    ...
    if major == 3:
        ...
        show_message_box(
            f"Blender {major}.{minor} tidak didukung. Gunakan Blender 3.x.",
